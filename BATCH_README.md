...
| 股票代码 | 投资建议 | 详细报告 |
|---------|---------|----------|
| 688111.SH | 🟡 HOLD | [查看详细分析](results/688111.SH/2025-08-03/reports/final_trade_decision.md) |
| AAPL | 🟢 BUY | [查看详细分析](results/AAPL/2025-08-03/reports/final_trade_decision.md) |

💡 **说明**: 点击"查看详细分析"链接可查看完整的投资决策依据和分析过程。
```
